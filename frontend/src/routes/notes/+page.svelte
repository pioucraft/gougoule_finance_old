<div id="wrapper">
    ...
    <div id="editor">
        ...
        <div id="editor-title">
            <h1 id="editor-title-title">{opened.split("/")[opened.split("/").length-1]}</h1>
            {#if opened}
...
<script>
    ...
    import { createNewFolder, createNewNote, expandFolder, makeData, editNote, deleteNote } from "./script"
